...
public class EstadisticasResource {
    ...
    @Timed
    public ResponseEntity<Estadisticas> createEstadisticas(@RequestBody Estadisticas estadisticas) throws URISyntaxException {
    ...
    @RequestMapping(value = "/estadisticass",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Estadisticas> updateEstadisticas(@RequestBody Estadisticas estadisticas) throws URISyntaxException {
