...
import com.xmollv.repository.PartidoRepository;
...
public class PartidoResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_FECHA_PARTIDO = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneId.systemDefault());
    private static final ZonedDateTime UPDATED_FECHA_PARTIDO = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    private static final String DEFAULT_FECHA_PARTIDO_STR = dateTimeFormatter.format(DEFAULT_FECHA_PARTIDO);
    ...
    public void getAllPartidos() throws Exception {
        ...
        restPartidoMockMvc.perform(get("/api/partidos"))
                ...
                .andExpect(jsonPath("$.[*].fechaPartido").value(hasItem(DEFAULT_FECHA_PARTIDO_STR)));
    }
    ...
    public void getPartido() throws Exception {
        ...
        restPartidoMockMvc.perform(get("/api/partidos/{id}", partido.getId()))
            ...
            .andExpect(jsonPath("$.fechaPartido").value(DEFAULT_FECHA_PARTIDO_STR));
    }
