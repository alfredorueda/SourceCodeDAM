...
public class PotenciometreVertical extends View
    ...
    public PotenciometreVertical(Context context, AttributeSet attrs,
        ...
        setMagnet(true);
        paint = new Paint();
        paint.setTextSize(2 * GAPH - 8);
        bola = context.getResources()
                .getDrawable(R.drawable.bola_potenciometre);
    ...
    private void readAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.PotenciometreVertical);
        setMin(a.getInt(R.styleable.PotenciometreVertical_minValue, 0));
        setMax(a.getInt(R.styleable.PotenciometreVertical_maxValue, 10));
        setValue(a.getInt(R.styleable.PotenciometreVertical_value, 5));
        setTickSize(a.getInt(R.styleable.PotenciometreVertical_tickSize, 1));
        setShowTicks(a.getBoolean(R.styleable.PotenciometreVertical_showTicks, true));
        setMagnet(a.getBoolean(R.styleable.PotenciometreVertical_magnet, false));
        a.recycle();
    }
    ...
    public void setValue(int value) {
        ...
        this.value = value;
        this.invalidate();
        if (listener != null) listener.valueChanged(this, oldValue, value);
    }
    ...
    private static final int GAPW = 30;
    private static final int GAPH = 20;
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(cx, GAPH, cx, h - GAPH, paint);
        int y = valToY(value);
        bola = getResources().getDrawable(R.drawable.bola_potenciometre);
        bola.setBounds(cx - 25, y - 18, cx + 25, y + 18);
        bola.draw(canvas);
