package cat.flx.slidecalcattrs;
...
public class SeekWithTextView extends LinearLayout
    ...
    public void readAttributes(Context context, AttributeSet attrs) {
        TypedArray a =
                context.obtainStyledAttributes(attrs, R.styleable.SeekWithTextView);
        try {
            setMax(a.getInt(R.styleable.SeekWithTextView_maxValue, 10));
            setValue(a.getInt(R.styleable.SeekWithTextView_value, 0));
        } finally {
            a.recycle();
        }
    }
