...
$(document).on("click", "#ferFoto", function () {
...
function onSuccess2(imageData) {
    ...
    $('#fotoFeta').attr("src", "data:image/jpeg;base64," + imageData);
}
...
$(document).on("click", "#addElementToTheList", function () {
    ...
    var srcImage = $('#fotoFeta').attr("src");
    ...
    $('#items').append("<li><a href='#detailsSofaGrande'><img src='" + srcImage + "'>" + descripcion + "</a></li>");
    $('#items').listview('refresh');
